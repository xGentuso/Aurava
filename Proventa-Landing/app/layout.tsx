  ...
  return (
    <html lang="en" className={`${inter.variable} scroll-smooth`}>
      ...
      <body className="bg-white">
        <div className="fixed top-0 left-0 right-0 bg-primary-600 text-white z-50">
          ...
          <div className="bg-primary-600 px-4 py-2 text-center text-sm">
            <div className="inline-flex items-center justify-center flex-wrap gap-2">
              ...
              <a href="#waitlist" className="font-semibold hover:text-primary-100 inline-flex items-center">
                Get Early Access
        ...
        {/* Add padding to the main content to account for the fixed banner */}
        <div className="pt-12">
          <Navigation />
          {children}
